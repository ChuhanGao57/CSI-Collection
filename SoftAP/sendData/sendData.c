...
#define DEFAULT_DEST_MAC0	0x44
#define DEFAULT_DEST_MAC1	0x39
#define DEFAULT_DEST_MAC2	0xC4
#define DEFAULT_DEST_MAC3	0x5B
#define DEFAULT_DEST_MAC4	0xC6
#define DEFAULT_DEST_MAC5	0xC0
...
int main(int argc, char *argv[])
{
    ...
    if (argc == 1)
    {
        ...
        printf("Example: %s wlp3s0 44:39:C4:5B:C6:C0 100\n",argv[0]);
        exit(0);
    }
